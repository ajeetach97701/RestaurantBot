...
def food_verify(user_input):
    ...
    If the food is available in the context and has multiple foods for it, return the output to the user as JSON FORMAT with two fields: "food_name" and "price".
